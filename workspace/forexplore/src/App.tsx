...
import { moduleTree } from './data/moduleTree';
import type { AdaptationStrategy, RetrievalMode } from './domain/model';
import {
  initialWorkflowState,
  selectedCandidate,
  workflowReducer,
} from './domain/workflow';
import { mockWorkflowPorts } from './services/mockAdapters';
