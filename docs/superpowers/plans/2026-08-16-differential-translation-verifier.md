...
function csharpJsonWriterSource(): string {
  return [
    ...
    `    public JsonWriter BeginObject() { out.Write("{"); return this; }`,
    `    public JsonWriter EndObject() { out.Write("}"); return this; }`,
    `    public JsonWriter BeginArray() { out.Write("["); return this; }`,
    `    public JsonWriter EndArray() { out.Write("]"); return this; }`,
    `    public JsonWriter Name(string name) { out.Write("\\""); out.Write(Escape(name)); out.Write("\\":"); return this; }`,
